 ...
 */
@Getter
public class FederatedTaskStartedEvent extends ApplicationEvent {
     ...
     */
    public FederatedTaskStartedEvent(Object source, String taskId, String taskName,
                                     String startedBy, String datasetId,
    ...
    public String toString() {
        return String.format("FederatedTaskStartedEvent{taskId='%s', taskName='%s', datasetId='%s', participantCount=%d, strategy='%s', eventTime=%s}",
