...
public class TaskOperationVO {
    ...
    private ConfigSummaryVO configSummary;
    private ResourcePreparationSummary resourcePreparation;
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    public static class ConfigSummaryVO {
        private InitialModelSummary initialModel;
    }
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    public static class InitialModelSummary {
        private String mode;
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    public static class ResourcePreparationSummary {
        ...
        private List<String> pendingDatasetVmIds;
        private List<String> pendingModelVmIds;
        ...
        private List<RoundDatasetBinding> datasetBindingsSnapshot;
    }
}
