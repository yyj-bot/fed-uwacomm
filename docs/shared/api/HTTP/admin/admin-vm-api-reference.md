...
## 概述
本文档描述了管理员专用的虚拟机管理API接口，所有接口都需要管理员权限。
...
- [管理员用户管理API](./admin-api-reference.md) - 管理员用户管理相关接口
- [虚拟机API](../vm/vm-api-reference.md) - 普通用户虚拟机操作接口
- [联邦任务API](../federated-task/federated-task-api-reference.md) - 联邦学习任务管理接口